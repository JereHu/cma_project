...
# group weekdays, leave out everything that's not bike data, filter the polygon, also leave out 4-11-2023 and 4-25-2023, because I was at gym only
...
- exclude downhill segments (if segment mean gradient is <-3)
  ...
  - might have to redo the segmentation. First create a column
